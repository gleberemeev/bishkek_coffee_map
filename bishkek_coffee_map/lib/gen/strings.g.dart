...
///
/// Built on 2023-10-12 at 07:41 UTC
...
enum AppLocale with BaseAppLocale<AppLocale, _StringsEn> {
	...
	ky(languageCode: 'ky', build: _StringsKy.build),
...
// Path: <root>
class _StringsKy implements _StringsEn {

	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	_StringsKy.build({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = TranslationMetadata(
		    locale: AppLocale.ky,
		    overrides: overrides ?? {},
	...
	@override late final _StringsKy _root = this; // ignore: unused_field
